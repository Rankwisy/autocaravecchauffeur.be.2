...
export default function ContactFormAstro() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus('error');
      setErrorMessage(
        'Une erreur est survenue. Veuillez réessayer ou contactez-nous par email.'
      );
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600">
              Devis gratuit et sans engagement. Nous vous répondons sous 48h. Utilisez le
              formulaire ci-dessous ou contactez-nous par email / WhatsApp.
            </p>
          </div>
            ...
            <div className="mb-8 bg-gradient-to-r from-lime-50 to-lime-100 border-2 border-lime-400 p-8 rounded-xl shadow-lg">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-lime-800 mb-2">Votre demande a été envoyée avec succès.</p>
